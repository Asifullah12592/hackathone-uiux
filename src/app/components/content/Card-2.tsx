...
const Card2 = () => {
    ...
    return (
        ...
        <div className='w-[1312px] h-fit  m-auto bg-contentBg mt-5 '>
...
<div className="w-[304px] h-[388px] bg-white">
            ...
            <div className="w-full m-auto mt-5 mb-5"> <button className="w-[116px] h-[44px]  rounded-[5px] bg-primary500 ml-[620px] text-white">Rent Now</button></div>
        </div>
